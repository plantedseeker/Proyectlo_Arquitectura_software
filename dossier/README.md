...
Las vistas C4 `05` a `08` provienen del paquete aprobado por el profesor. La
procedencia y las huellas SHA-256 se registran en el documento `09`.

La evidencia técnica de S7–S8 está en `../experimentos/localizacion-s7/`,
`../docs/adr/` y `../docs/architecture/`.
...
| Juan Carlos Barragán Arévalo (`juan147157`) | `architecture/s8-adr-ci` | Por asignar | En preparación; requiere revisión personal antes de publicar |
...
aportar y fusionar otro PR real con una contribución identificable. Cada dueño
de cuenta debe revisar y autorizar personalmente su contribución. No se fabrican
autores, revisiones ni veredictos.
