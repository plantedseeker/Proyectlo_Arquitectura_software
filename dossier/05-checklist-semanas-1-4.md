...
| 1 | Repositorio con flujo PR | Cumple | [PR #1](https://github.com/plantedseeker/Proyectlo_Arquitectura_software/pull/1), revisado por CI y fusionado a `main` |
| 1 | PR con `01-contexto-sistema.md` | Cumple | `01-contexto-sistema.md` fue incorporado mediante el PR #1 |
...
| 3 | PR con `03-atributos-calidad.md` | Cumple | `03-atributos-calidad.md` fue incorporado mediante el PR #1 |
...
| 4 | PR con `04` y `/experimentos` | Cumple | Ambos fueron incorporados mediante el PR #1 |
